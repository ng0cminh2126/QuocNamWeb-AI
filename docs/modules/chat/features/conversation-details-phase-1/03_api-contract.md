...
👉 **Xem chi tiết tại:** [docs/api/chat/conversation-details-phase-1/contract.md](../../../../api/chat/conversation-details-phase-1/contract.md)
...
| --------------------------------------------------------------------------------------------------------------------- | --------------------- | ---------- |
| [get-messages-success.json](../../../../api/chat/conversation-details-phase-1/snapshots/v1/get-messages-success.json) | Response GET messages | ✅         |
